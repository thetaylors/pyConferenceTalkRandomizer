...
GITHUB_SVG = """<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                [
                    div(
                        ...
                        children=[
                            ...
                            hr(),
                            p(
                                """The following link leads to the webpage of a random conference talk, chosen from all of the 
                    talks given in general conference since April 1971.<br>50% of the time the talk will be chosen from 
                    the most recent conference."""
                            ...
                            p(
                                [
                                    input_(
                                        {
                                            "type": "checkbox",
                                            "id": "prioritize_latest",
                                            "onclick": "save_checkbox_state()",
                                            "keydown": "save_checkbox_state()",
                                        }
                                    ),
                                    "&nbsp;",
                                    label(
                                        {"for": "prioritize_latest"},
                                        children=[
                            ...
                            p(
                                " Click the button to change the link to a different random talk, or refresh the page."
                            ),
                            p(
                                input_(
                                    {
                                        "type": "button",
                                        "onclick": "set_talk_link(show_badge=true)",
                                        "value": "Change talk link",
                                    }
                                )
                            ),
                                ...
                                [
                                    ...
                                    div(
                                        ...
                                        [
                                            a(
                                                {
                                                    "href": "https://github.com/thetaylors/pyConferenceTalkRandomizer"
                                                },
                                                GITHUB_SVG,
                                            ),
                                            "&nbsp;",
