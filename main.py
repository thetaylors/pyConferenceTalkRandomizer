        ...
        html(children=[
            ...
            body([
                div({'class': 'container'}, children=[
                    ...
                    hr(),
                    p('''The following link leads to the webpage of a random conference talk, chosen from all of the 
                    ...
                    p([
                        a({'href': '', 'id': 'talk_link', 'target': '_blank'}, "Open talk page"),
                        span('&nbsp;'),
                        span({'id': 'badge'})
                      ]),
                    # TODO p([
                ...
                div({'class': 'container'}, children=[
                    div({'class': 'row justify-content-between'}, [
                        ...
                        div({'class': 'col-1'}, [
                            a({'href': 'https://github.com/thetaylors/pyConferenceTalkRandomizer'}, GITHUB_SVG),
                            '&nbsp;',
                            a({'href': 'https://github.com/thetaylors/pyConferenceTalkRandomizer'}, 'Source')
                        ])
                    ])
                ])
            ])
